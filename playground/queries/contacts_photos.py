...
IMG_PATH = "C:\\Users\\IEUser\\Desktop\\python\\"
...
STDOUT_ALL_OK = "All files successfully created!"
...
def printContactInfo(messengerDB):
    ...
    row_counter = 1
    for row in c:
        print("Taking care of " + str(row_counter) +
              "/" + str(last_row) + "\r", flush=True)
        # querry fields
        ...
        if contact_pic != 'None':
            ...
            if req.status_code == requests.codes.ok:
                try:
                    ...
                    # create image file
                    img_file = IMG_PATH + \
                        str(contact_name) + "_" + str(contact_phone) + \
                        "_" + str(contact_email) + "_" + ext
