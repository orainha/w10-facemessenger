            ...
            try:
                ...
                if not message or message == 'None':
                    ...
                    if "xma_rtc" in cta_type:
                        previous_file.write("<li>["+ datetime +"]"+ sender_name +" : "+ cta_title + " - " + cta_subtitle +"</li>")
                    #se não tiver "xma_rtc" há de ser outra coisa, e sempre assim
                    elif "image" in cta_url_mimetype:
                        previous_file.write("<li>["+ datetime +"]"+ sender_name +" : ""<img src="+cta_preview_url+"></img></li>")
                    #TODO: continuar esta parte, verificar também nos outros casos de threadkey
                    elif "audio" in cta_url_mimetype:
                        previous_file.write("<li>["+ datetime +"]"+ sender_name +" : Audio - "+ cta_title + " - " + cta_subtitle +"</li>")
                    elif "video" in cta_url_mimetype:
                        previous_file.write("<li>["+ datetime +"]"+ sender_name +" : Video - "+ cta_title + " - " + cta_subtitle +"</li>")
                else:
                    previous_file.write("<li>["+ datetime +"]"+ sender_name +" : "+ message +"</li>")
                previous_file.close()
            except IOError as error:
                print (error)
